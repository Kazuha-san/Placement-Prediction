...
class ProfileCreate(BaseModel):
    ...
    internships: int = Field(..., ge=0, le=10, description="Number of internships must be between 0 and 10")
    projects: int = Field(..., ge=0, le=50, description="Number of projects must be between 0 and 50")
    certifications: int = Field(..., ge=0, le=50, description="Number of certifications must be between 0 and 50")
    ...
    backlogs: int = Field(..., ge=0, le=10, description="Active backlog count must be between 0 and 10")
